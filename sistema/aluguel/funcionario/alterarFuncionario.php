...
<head>
<title>Alteração de dados do Funcionarios</title>
...
<header >
        ...
        <li><a href="../alugar/listarAluguelDisponivel.php">Aluguéis |</a></li>
          ...
          <h1 class>Alterar dados do funcionário<h1>
            </div>
      ...
      $id = $_POST['id'];
       ...
       if ( isset($_POST['alterarDados'])){
           ...
           if($funcionario->update($id)){
                echo "<script language='javascript' type='text/javascript'> alert('Funcionario atualizado com sucesso');window.location.href='listarFuncionario.php';</script>";
           }else{
            echo "oi";
           }
        }
  ...
  <form method='post' action="">
    ...
    <div class="inputBox">
        ...
        <input type="text" maxlength="45" name="nome" value="<?php echo $nome;?>"/>
        <br><br>
...
<div class="inputBox"> 
        ...
        <input type="text" maxlength="45" name="cidade"value="<?php echo $cidade;?>"/>
        <br><br>

  
<div class="inputBox">      
        <label for='Bairro'> Bairro:</label><br>
        <input type="text" maxlength="45" name="bairro" value="<?php echo $bairro;?>"/>
        <br><br>

  
<div class="inputBox"> 
        <label for='Numero'> Número: </label>    <br>
        <input type="text" maxlength="10" name="numero"value="<?php echo $numero;?>"/>
        <br><br>

  
<div class="inputBox"> 
        <label for='Rua'> Rua: </label>    <br>
        <input type="text" maxlength="45" name="rua"value="<?php echo $rua;?>"/>
        <br><br>

  
<div class="inputBox"> 
        <label for='Email'> Email: </label>    <br>
        <input type="text" maxlength="45" name="email"value="<?php echo $email;?>"/>
        <br><br>
