...
<html lang="pt-br">
    ...
    //   die();
      if(isset($_POST['submit'])):
            ...
            if($modelo->insert()){
                echo "<script language='javascript' type='text/javascript'> alert('Modelo cadastrado com sucesso');window.location.href='listarModelo.php';</script>";
            }
      endif;
    ?>
                 <div class="box1">
        <div class="form-box">
                    ...
                    <fieldset>
                        <div class="margem">
                            ...
                            <div class="inputBox">
                            <label for="nome" >Modelo do veiculo:</label><br>
                                <input type="text" name="modelo" placeholder="Modelo" id="nome"  required>
                            ...
                            <label for="marca">Escolha uma marca:</label><br>
                                <select name="marca" id="escolha-marca">
