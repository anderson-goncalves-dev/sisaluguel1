...
<head>
        <title>Lista de carros disponíveis</title>
...
<header >
        ...
        <li><a href="../alugar/listarAluguelDisponivel.php">Aluguéis |</a></li>
          ...
          <h1 class>Lista de Veículos Disponíveis para alugar<h1>
            </div>
    ...
    <table class="tabela">
                ...
                <tbody>
                    ...
                    foreach ($veiculo->findAllDisponivel() as $key => $value) { ?> 
                    ...
                    <td>
                        ...
                        <form method="post" action="alterarVeiculo.php">
                            ...
                            <form method="post" action="../alugar/alugarCarro.php">
                                    <input name="id_veiculo" type="hidden" value="<?php echo $value->id_veiculo;?>"/>
                                    <input name="valor_diaria" type="hidden" value="<?php echo $value->valor_diaria;?>"/>
                                    <button name="alugar" class="alugar" type="submit" >Alugar</button>
                                </form>
                                </td>
